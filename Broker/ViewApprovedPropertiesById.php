...
<section class="w3l-content-with-photo-1">
    <div class="ab-content-6-mian py-5">
        <div class="container py-lg-5">
            ...
            $id = $_GET['id'];
            $qry = mysql_query("SELECT DISTINCT p.*,o.*,a.`status`,a.`aid` FROM `assignedproperty` a,`owner` o,`property` p,`broker` b,`login` l WHERE a.`pid`=p.`pid` AND p.`uid`=o.`uid` AND a.`oid`=o.`uid` AND a.`brid`=l.`uid` AND a.`status`='Accepted' AND a.`aid`='$id'");
                ...
                while ($row = mysql_fetch_array($qry)) {
                    ...
                    <div class="welcome-grids row">
                        ...
                        <div class="col-lg-6 mt-lg-0 mt-5 pl-lg-4">
                            ...
                            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                            <div class="read">
                                <a class="btn mt-4" href="../Broker/ViewBuyers.php">Send Details To Buyer</a>
