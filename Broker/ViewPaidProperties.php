    ...
    <div class="team py-5">
        <div class="container py-lg-5">
            ...
            <div class="row team-row">
                ...
                $uid=$_SESSION['USERID'];
                $qry = mysql_query("SELECT DISTINCT p.*,b.*,a.`status`,a.`aid` FROM `assignedproperty` a,`buyer` b,`property` p,`login` l WHERE a.`brid`=l.`uid` AND a.`buid`=b.`uid` AND a.`pid`=p.`pid` AND a.`payment`='Payed' AND l.`uid`='$uid'");
