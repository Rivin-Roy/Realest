...
<section class="w3l-content-with-photo-1">
    <div class="ab-content-6-mian py-5">
        <div class="container py-lg-5">
            ...
            $id = $_GET['id'];
            $qry = mysql_query("SELECT DISTINCT p.*,b.*,a.`status`,a.`aid` FROM `assignedproperty` a,`buyer` b,`property` p,`login` l WHERE a.`brid`=l.`uid` AND a.`buid`=b.`uid` AND a.`pid`=p.`pid` AND a.`payment`='Pending' AND a.`aid`='$id'");
