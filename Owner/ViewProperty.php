    ...
    <div class="team py-5">
        <div class="container py-lg-5">
            ...
            <div class="row team-row">
                ...
                $uid=$_SESSION['USERID'];
                $qry = mysql_query("SELECT DISTINCT p.* FROM `assignedproperty` a,`property` p,`login` l WHERE a.`oid`=l.`uid` AND l.`uid`=p.`uid` AND a.`pid`=p.`pid` AND a.`payment`='Pending' AND l.`uid`='$uid'");
