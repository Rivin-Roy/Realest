...
<section class="w3l-content-with-photo-1">
    <div class="ab-content-6-mian py-5">
        <div class="container py-lg-5">
            ...
            $id = $_GET['id'];
            $qry = mysql_query("SELECT DISTINCT p.*,b.*,a.`status`,a.`aid` FROM `assignedproperty` a,`owner` o,`property` p,`broker` b,`login` l WHERE a.`brid`=b.`uid` AND a.`status`!='Payed' AND p.`pid`=a.`pid` AND a.`aid`='$id'");
                    ...
                    <div class="welcome-grids row">
                        ...
                        <div class="col-lg-6 mt-lg-0 mt-5 pl-lg-4">
                            ...
                            <div class="title-content text-left">
                                ...
                                <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                                <div class="read">
                                    <a class="btn mt-4" href="../Action/BuyerSendReq.php">Add To Recommendation</a>
                                </div>
                            </div>
