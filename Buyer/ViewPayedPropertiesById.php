...
<section class="w3l-content-with-photo-1">
    <div class="ab-content-6-mian py-5">
        <div class="container py-lg-5">
            ...
            $id = $_GET['id'];
            $qry = mysql_query("SELECT DISTINCT p.*,b.*,a.`status`,a.`aid` FROM `assignedproperty` a,`broker` b,`property` p,`login` l WHERE a.`buid`=l.`uid` AND a.`brid`=b.`uid` AND p.`pid`=a.`pid` AND a.`payment`='Payed' AND a.`aid`='$id'");
