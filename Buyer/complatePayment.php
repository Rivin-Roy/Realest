                    ...
                    <div class="agileits_main_grid_left1 agileits_main_grid_left1">
                        <form method="POST" class="creditly-card-form agileinfo_form">
                            <section class="creditly-wrapper wthree, w3_agileits_wrapper">
                                <div class="credit-card-wrapper">
                                    <div class="first-row form-group">
                                        <div class="controls">
                                            <a href="ViewAssignedProperties.php"><h1>Cancel Payment</h1></a>
                                        </div>
                                        <div class="controls">
                                            &nbsp;
                                        ...
                                        <button class="button" name="submit">PAY</button>
                            ...
                            if (isset($_POST['submit'])) {
                                $aid = $_SESSION['AID'];
                                $qry = "UPDATE `assignedproperty` SET `payment`='Payed' WHERE `aid`='$aid'";
                                $exe = mysql_query($qry);
                                if ($qry) {
                                    echo '<script>alert("payment Successfull")</script>';

                                    echo '<script>location.href="BuyerHome.php"</script>';
                                } else {
