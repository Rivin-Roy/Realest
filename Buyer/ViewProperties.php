    ...
    <div class="team py-5">
        <div class="container py-lg-5">
            ...
            <div class="row team-row">
                ...
                $uid=$_SESSION['USERID'];
                $qry = mysql_query("SELECT DISTINCT p.*,b.*,a.`status`,a.`aid` FROM `assignedproperty` a,`owner` o,`property` p,`broker` b,`login` l WHERE a.`brid`=b.`uid` AND a.`status`!='Payed' AND a.`payment`='Pending' AND p.`pid`=a.`pid`");
                    ...
                    while ($row = mysql_fetch_array($qry)) {
                        ...
                        <div class="col-lg-3 col-sm-6 team-wrap">
                            <div class="team-info text-left">
                                ...
                                <div class="column">
                                    <h3 class="name-pos"><a href="ViewPropertiesById.php?id=<?php echo $row['aid'] ?>"><?php echo $row['pname'] ?></a></h3>
